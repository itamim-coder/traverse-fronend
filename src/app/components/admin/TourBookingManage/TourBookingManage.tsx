  ...
  return (
    <div className="m-5">
      ...
      <div className="overflow-x-auto">
            ...
            {tourBooking?.data?.result.map((data: any, index: number) => (
              <>
                <tr className="hover:bg-gray-50 border-b transition duration-300">
                  ...
                  <td className="py-4 px-6 border-b text-base font-medium">
                    {data?.tourBooks?.tourInfo?.title}
                  </td>
                  <td className="py-4 px-6 border-b text-base font-medium">
                    {data?.status}
                  </td>
                  <td className="py-4 px-6 border-b text-base font-medium">
                    {data?.tourBooks?.totalAmount}
                  </td>
                  <td className="py-4 px-6 border-b text-base font-medium">
                    {data?.status}
                  </td>
                  <td className="py-4 px-6  border-b text-end">
                    <button
                      onClick={() => {
                        ...
                        document.getElementById("my_modal_3a").showModal();
                      }}
        ...
        <dialog id="my_modal_3a" className="modal">
